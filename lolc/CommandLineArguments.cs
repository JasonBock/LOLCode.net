...
namespace CommandLine
{
	...
	public class ArgumentAttribute : Attribute
	{
		...
		/// </summary>
		public bool HasDefaultValue => null != this.DefaultValue;

		/// <summary>
		/// Returns true if the argument has help text specified.
		/// </summary>
		public bool HasHelpText => this.HelpText != null;
	...
	public sealed class Parser
	{
		...
		private void ReportUnrecognizedArgument(string argument) => this.reporter(string.Format("Unrecognized command line argument '{0}'", argument));
		...
		public bool HasDefaultArgument => this.defaultArgument != null;
		...
		private static bool IsValidElementType(Type type) => type != null && (
				  type == typeof(int) ||
				  type == typeof(uint) ||
				  type == typeof(string) ||
				  type == typeof(bool) ||
		...
		private class Argument
		{
			...
			private void ReportDuplicateArgumentValue(string value) => this.reporter(string.Format("Duplicate '{0}' argument '{1}'", this.LongName, value));
			...
			private void ReportBadArgumentValue(string value) => this.reporter(string.Format("'{0}' is not a valid value for the '{1}' command line option", value, this.LongName));
			...
			public bool ExplicitShortName => this.explicitShortName;

			public string ShortName => this.shortName;

			public bool HasShortName => this.shortName != null;

			public void ClearShortName() => this.shortName = null;

			public bool HasHelpText => this.hasHelpText;
			...
			public bool IsRequired => 0 != (this.flags & ArgumentType.Required);

			public bool SeenValue => this.seenValue;

			public bool AllowMultiple => 0 != (this.flags & ArgumentType.Multiple);

			public bool Unique => 0 != (this.flags & ArgumentType.Unique);
